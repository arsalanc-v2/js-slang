...
Unlike Source \S 3, loops in Source \S 3 Non-Det do not use constant memory. Memory usage increases linearly with the number of iterations as recursion is used to allow for non-determinism. This is to be able to keep track of the branches of an iteration that have yet to be evaluated.
