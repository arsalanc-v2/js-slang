...
Unlike Source \S 3, loops in Source \S 3 Non-Det do not use constant memory. Memory usage increases linearly with the number of iterations. <- TODO: CHECK IF THIS IS TRUE
